...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-T5RGDBCV.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-65YX7L3O.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-P3NJSCMY.js")).default(client, args, telemetry);
    default:
