...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-3L6EN4YU.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-3L6EN4YU.js")).default(client, args);
    case "add":
      return (await import("./add-E4KH6P4A.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-M3QUSPU2.js")).default(client, args);
    case "rm":
      return (await import("./rm-HUED5R3Q.js")).default(client, args);
    case "update":
      return (await import("./update-VJCKD6YG.js")).default(client, args);
    default:
