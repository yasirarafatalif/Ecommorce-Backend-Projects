...
__export(src_exports, {
  ...
  PyProjectToolVercelFastapiSectionSchema: () => PyProjectToolVercelFastapiSectionSchema,
  PyProjectToolVercelFastapiStaticSectionSchema: () => PyProjectToolVercelFastapiStaticSectionSchema,
  PyProjectToolVercelSectionSchema: () => PyProjectToolVercelSectionSchema,
...
var pyProjectToolVercelFastapiStaticSectionSchema = import_zod4.z.object({
  cdn: import_zod4.z.boolean().optional()
});
var pyProjectToolVercelFastapiSectionSchema = import_zod4.z.object({
  static: pyProjectToolVercelFastapiStaticSectionSchema.optional()
});
var pyProjectToolVercelSectionSchema = import_zod4.z.object({
...
var PyProjectToolVercelSectionSchema = pyProjectToolVercelSectionSchema;
var PyProjectToolVercelFastapiSectionSchema = pyProjectToolVercelFastapiSectionSchema;
var PyProjectToolVercelFastapiStaticSectionSchema = pyProjectToolVercelFastapiStaticSectionSchema;
var PyProjectToolSectionSchema = pyProjectToolSectionSchema.passthrough();
var PyProjectTomlSchema = pyProjectTomlSchema.extend({ tool: PyProjectToolSectionSchema.optional() }).passthrough();
